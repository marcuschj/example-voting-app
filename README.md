...
Download [Docker Desktop](https://www.docker.com/products/docker-desktop) for Mac, Windows, and Linux desktop. [Docker Compose](https://docs.docker.com/compose) will be automatically installed. On Linux, make sure you're using the official [Docker Engine for Linux install steps](https://docs.docker.com/engine/install/) and you'll also get the latest compose plugin.
